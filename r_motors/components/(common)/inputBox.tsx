...
const InputBox = <T extends string>({inputType,inputPlaceholder,inputWidth,inputMaxWidth,value,setValue,name,className}: InputBoxProp) => {
  ...
  return (
    <div className={`w-full h-full flexClass  ${className? className : ""}`}>
      <input 
        className='p-1 rounded-md shadow-md h-[90%] border-black max-w-[300px] '
        ref={ref}
        type={`${inputType || "text"}`} 
