...
const AddCarsPage = () => {
  ...
  return (
    <section className='w-full h-max shadow-md rounded-md p-4 gap-y-4 grid  md:grid-cols-2'>
        ...
        <div className='w-full h-max flex justify-between items-center flex-col md:flex-row col-span-full gap-y-4 md:gap-x-2'>
            <DragAndDropComponent />
            <CarDetailsInputBoxes />
        </div>
        <div className='w-full h-max flex justify-center items-start flex-col gap-y-2 col-span-full'>
            <p>Description</p>
            <input type="text" placeholder='Enter detailed description of the car...' className='w-full min-h-[100px] p-1 border-1 border-gray-200 active:border-blue-400 rounded-md'/>
        </div>
        <div className='w-full h-max flex justify-center md:justify-end items-center  col-span-full'>
            <div className='w-full md:h-max md:w-1/3 flexClass gap-x-2'>
                ...
                <Button btnText='Add Car' btnWidth={100}/> 
